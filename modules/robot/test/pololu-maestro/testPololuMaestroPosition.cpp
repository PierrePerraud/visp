...
int main()
{
  ...
  servo1.setPositionPWM(2800, 0);
  std::this_thread::sleep_for(3 * sec);
  servo1.setPositionPWM(8800, 0);
  std::this_thread::sleep_for(3 * sec);
  ...
  servo1.setPositionPWM(2800);
  servo2.setPositionPWM(2800, 0);
  std::this_thread::sleep_for(3 * sec);
  servo1.setPositionPWM(8800, 0);
  servo2.setPositionPWM(8800, 0);
  std::this_thread::sleep_for(3 * sec);
